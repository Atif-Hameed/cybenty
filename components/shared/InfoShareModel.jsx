...
const InfoShareModel = ({ onClose, targetUrl, updateData }) => {
    const pathname = usePathname();
    const searchParams = useSearchParams();
    const [isCopied, setIsCopied] = useState(false);
    const resourcesId = searchParams.get('targetId')
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText(targetUrl).then(async () => {
